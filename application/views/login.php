...
<form action="<?=base_url()?>login/auth" method="post">
  ...
  <label for=""></label>
  <input type="text" name="email" id="" placeholder="email" class="email"><i class="fa fa-circle-o">
    
  <label for=""></label>
  <input type="password" name="pass" id="" placeholder="password" class="pass"><i class="fa fa-">
...
#bg {
  ...
  width: 100%;
  height: 100%;
  background: url(http://localhost/pt_luas_mulya_jaya/assets/images/FLAT8.jpg) no-repeat center center fixed;
...
border-bottom-color: rgba(248, 248, 248, 0);
