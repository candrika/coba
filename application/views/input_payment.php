...
<body  class="hold-transition skin-blue sidebar-mini">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Just</b> Template</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/charts/inline.html"><i class="fa fa-circle-o"></i></a></li>
          </ul>
        </li> -->
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/UI/general.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/UI/icons.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/UI/buttons.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/UI/sliders.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/UI/timeline.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/UI/modals.html"><i class="fa fa-circle-o"></i> Menu</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="pages/forms/editors.html"><i class="fa fa-circle-o"></i></a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/tables/data.html"><i class="fa fa-circle-o"></i>Menu</a></li>
          </ul>
        </li>
        <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="pages/examples/invoice.html"><i class="fa fa-circle-o"></i>Menu</a></li>
            <li><a href="pages/examples/profile.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/examples/login.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/examples/register.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/examples/lockscreen.html"><i class="fa fa-circle-o"></i> Menu</a></li>
            <li><a href="pages/examples/404.html"><i class="fa fa-circle-o"></i>Menu</a></li>
            <li><a href="pages/examples/500.html"><i class="fa fa-circle-o"></i>Menu</a></li>
            <li><a href="pages/examples/blank.html"><i class="fa fa-circle-o"></i>Menu</a></li>
            <li><a href="pages/examples/pace.html"><i class="fa fa-circle-o"></i>Menu</a></li>
          </ul>
        </li>
        <!-- <li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-lg-3">
            <form action="<?php echo base_url().'/integrasi/payment';?>"method="post" form="multipart">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label>Input Amount</label></td>
                        <td><input type="text" name="amount"/></td>
                    </tr>
                    <tr>
                        <td><label>Input Virtual Account</label></td>
